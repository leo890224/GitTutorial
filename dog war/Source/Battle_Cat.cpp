...
namespace game_framework
{
	...
	int Battle_Cat::GetX2()
	{
		return x + walk.Width();
	}

	int Battle_Cat::GetY2()
	{
		return y + die.Height();
	}

	void Battle_Cat::LoadBitmap()
	{
		walk.AddBitmap(battle_cat, RGB(255, 255, 255));
		walk.AddBitmap(battle_cat2, RGB(255, 255, 255));
		walk.AddBitmap(battle_cat, RGB(255, 255, 255));
		walk.AddBitmap(battle_cat3, RGB(255, 255, 255));
		punch.AddBitmap(battle_cat_punch, RGB(255, 255, 255));
		attack.AddBitmap(battle_cat, RGB(255, 255, 255));
		attack.AddBitmap(battle_cat_attack, RGB(255, 255, 255));
		attack.AddBitmap(battle_cat_attack2, RGB(255, 255, 255));
		attack.AddBitmap(battle_cat_attack, RGB(255, 255, 255));
		attack.AddBitmap(battle_cat_attack3, RGB(255, 255, 255));
		attack.AddBitmap(battle_cat_attack4, RGB(255, 255, 255));
	...
	bool Battle_Cat::MeetDog(Dog* enemy)
	{
		if (!isDead)
		{
	...
	void Battle_Cat::OnShow(Background* map)
	{
		if (!isDead)
		{
			if (!isAttack && !isJump)
